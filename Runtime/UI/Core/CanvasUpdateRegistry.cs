...
namespace UnityEngine.UI
{
    ...
    public class CanvasUpdateRegistry
    {
        ...
        // HuaHua.
        // Key RectTransform
        public static HashSet<System.Object> LayoutDirty = new HashSet<System.Object>();
#endif
...
#if OPTIMIZE_UGUI
            //HuaHua.
            foreach (var rect in LayoutDirty)
            {
                LayoutRebuilder.RealMarkLayoutForRebuild((RectTransform)rect);
            }
            LayoutDirty.Clear();
#endif
