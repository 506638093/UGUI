...
namespace UnityEngine.UI
{
    ...
    {
        /// <summary>
        /// 项目里允许的字体最小的大小 小于该值的会被改成等于
        /// </summary>
        public static readonly int allowedMinFontSize = 32;
        ...
        public int fontSize
        {
            ...
            set { m_FontSize = m_BreakLimit ? value : Mathf.Max(value, allowedMinFontSize); }
        }
        ...
        {
            get { return m_BreakLimit; }
            set { m_BreakLimit = value; }
        }
        ...
        {
            m_FontSize = Mathf.Clamp(m_FontSize, m_BreakLimit ? 0 : allowedMinFontSize, 300);
            m_MinSize = Mathf.Clamp(m_MinSize, m_BreakLimit ? 0 : allowedMinFontSize, m_FontSize);
