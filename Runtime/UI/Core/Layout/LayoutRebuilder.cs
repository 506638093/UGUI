...
namespace UnityEngine.UI
{
    ...
    public class LayoutRebuilder : ICanvasElement
    {
...
#if OPTIMIZE_UGUI
        //HuaHua.
        public static void RealMarkLayoutForRebuild(RectTransform rect)
        {
            if (rect == null)
                return;
            ...
            while (validLayoutGroup && (System.Object)parent != null)
            {
                ...
                {
                    var cur = comps[i];
                    if (cur is Behaviour && ((Behaviour)cur).isActiveAndEnabled)
                    {
            ...
            if ((System.Object)layoutRoot == (System.Object)rect && !ValidController(layoutRoot, comps))
            {
        ...
        public static void MarkLayoutForRebuild(RectTransform rect)
        {
            ...
            CanvasUpdateRegistry.LayoutDirty.Add(rect);
#else
