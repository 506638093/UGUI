...
namespace UnityEngine.UI
{
    ...
    public class RectMask2D : UIBehaviour, IClipper, ICanvasRaycastFilter
    {
        ...
        [NonSerialized]
        protected HashSet<MaskableGraphic> m_MaskableTargets = new HashSet<MaskableGraphic>();

        [NonSerialized]
        protected HashSet<IClippable> m_ClipTargets = new HashSet<IClippable>();

        [NonSerialized]
        protected bool m_ShouldRecalculateClipRects;

        [NonSerialized]
        protected List<RectMask2D> m_Clippers = new List<RectMask2D>();

        [NonSerialized]
        protected Rect m_LastClipRectCanvasSpace;
        [NonSerialized]
        protected bool m_ForceClip;
        ...
        [SerializeField]
        protected Vector2Int m_Softness;
