...
namespace UnityEditor.UI
{
    ...
    public class FontDataDrawer : PropertyDrawer
    {
        ...
        private SerializedProperty m_BreakLimit;
        ...
        private float m_BreakLimitHeight = 0f;
        ...
        protected void Init(SerializedProperty property)
        {
            ...
            m_BreakLimit = property.FindPropertyRelative("m_BreakLimit");
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            m_BreakLimitHeight = EditorGUI.GetPropertyHeight(m_BreakLimit);
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                rect.y += rect.height + EditorGUIUtility.standardVerticalSpacing;
                rect.height = m_BreakLimitHeight;
                EditorGUI.PropertyField(rect, m_BreakLimit);

                rect.y += rect.height + EditorGUIUtility.standardVerticalSpacing;
                rect.height = m_ResizeTextForBestFitHeight;
