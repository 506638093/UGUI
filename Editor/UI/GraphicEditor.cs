...
namespace UnityEditor.UI
{
    ...
    public class GraphicEditor : Editor
    {
        ...
        protected SerializedProperty m_ReverseMask;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_ReverseMask = serializedObject.FindProperty("m_ReverseMask");            
        ...
        protected void MaskableControlsGUI()
        {
            ...
            EditorGUI.BeginDisabled(!m_Maskable.boolValue);
            EditorGUILayout.PropertyField(m_ReverseMask);
